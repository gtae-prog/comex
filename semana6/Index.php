...
$cliente = new comex\semana6\Cliente(1,'Fernando Eduardo C Silva','ferdo.castro@gmail.com', '11988580086','Rua Santa Bárbara, 111',[]);

$produto1 = new comex\semana6\Produto(1, 'Lápis', 1.99, 150);
$produto2 = new comex\semana6\Produto(2, 'Caderno', 15, 200);
$produto3 = new comex\semana6\Produto(3, 'Borracha', 0.50, 25);
...
<body>
    ...
    <h4>
        <?php 
            ...
            $pedido = new comex\semana6\Pedido(1, $cliente->getNome(), $produtos);
    ...
    <h4>
        <?php
            ...
            $carrinho = new comex\semana6\carrinhoCompras($produtos);
